...
from PySide6.QtWidgets import QWidget, QFrame, QLabel, QSizePolicy, QSpacerItem, QHBoxLayout, QApplication
...
class Header(QWidget):
    ...
    def _init_style(self):
        self.nameLabel.setFont(QFont('Microsoft YaHei', 14, QFont.Bold))
    ...
    def _init_layout(self):
        ...
        self.frame_layout.addWidget(self.nameLabel)
